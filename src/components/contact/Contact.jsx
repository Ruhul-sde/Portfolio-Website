...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (username === "") {
      ...
      emailjs
        .send(
          'service_wjzisas',       // Replace with your EmailJS service ID
          'template_ej1lrm8',       // Replace with your EmailJS template ID
          templateParams,
          'XivlUqU4cKFfRHFSm'            // Replace with your EmailJS user ID
        )
        .then(
          (response) => {
